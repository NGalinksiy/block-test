...
`,Tv=Object.defineProperty,Pv=(n,t,e)=>t in n?Tv(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Io=(n,t,e)=>(Pv(n,typeof t!="symbol"?t+"":t,e),e);const Fv=class nf extends X{constructor(...t){let e=t[0]??{};(typeof e=="number"||Array.isArray(e)||e instanceof Float32Array)&&(k("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),e={color:e},t[1]!==void 0&&(e.alpha=t[1])),e={...nf.DEFAULT_OPTIONS,...e};const i=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:Av,entryPoint:"mainFragment"}}),r=$.from({vertex:q,fragment:Cv,name:"color-overlay-filter"});super({gpuProgram:i,glProgram:r,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"}}}}),Io(this,"uniforms"),Io(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new j,this.color=e.color??0}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,i,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=i,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};Io(Fv,"DEFAULT_OPTIONS",{color:0,alpha:1});var Mv=`in vec2 vTextureCoord;
out vec4 finalColor;
...
`,v2=Object.defineProperty,y2=(n,t,e)=>t in n?v2(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Af=(n,t,e)=>(y2(n,typeof t!="symbol"?t+"":t,e),e);const b2=class Tf extends X{constructor(t){t={...Tf.DEFAULT_OPTIONS,...t};const e=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:x2,entryPoint:"mainFragment"}}),i=$.from({vertex:q,fragment:_2,name:"twist-filter"});super({gpuProgram:e,glProgram:i,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),Af(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};Af(b2,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var S2=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;

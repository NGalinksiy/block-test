...
`,zx=`struct AdvancedBloomUniforms {
  uBloomScale: f32,
  uBrightness: f32,
};
...
`,Rx=`struct ExtractBrightnessUniforms {
  uThreshold: f32,
};
...
`,kx=Object.defineProperty,Bx=(n,t,e)=>t in n?kx(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Xc=(n,t,e)=>(Bx(n,typeof t!="symbol"?t+"":t,e),e);const Hc=class jc extends X{constructor(t){t={...jc.DEFAULT_OPTIONS,...t};const e=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:Rx,entryPoint:"mainFragment"}}),i=$.from({vertex:q,fragment:Ox,name:"extract-brightness-filter"});super({gpuProgram:e,glProgram:i,resources:{extractBrightnessUniforms:{uThreshold:{value:t.threshold,type:"f32"}}}}),Xc(this,"uniforms"),this.uniforms=this.resources.extractBrightnessUniforms.uniforms}get threshold(){return this.uniforms.uThreshold}set threshold(t){this.uniforms.uThreshold=t}};Xc(Hc,"DEFAULT_OPTIONS",{threshold:.5});let Ux=Hc;var Lx=Object.defineProperty,Dx=(n,t,e)=>t in n?Lx(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ei=(n,t,e)=>(Dx(n,typeof t!="symbol"?t+"":t,e),e);const Gx=class qc extends X{constructor(t){t={...qc.DEFAULT_OPTIONS,...t};const e=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:zx,entryPoint:"mainFragment"}}),i=$.from({vertex:q,fragment:Ex,name:"advanced-bloom-filter"});super({gpuProgram:e,glProgram:i,resources:{advancedBloomUniforms:{uBloomScale:{value:t.bloomScale,type:"f32"},uBrightness:{value:t.brightness,type:"f32"}},uMapTexture:D.WHITE}}),Ei(this,"uniforms"),Ei(this,"bloomScale",1),Ei(this,"brightness",1),Ei(this,"_extractFilter"),Ei(this,"_blurFilter"),this.uniforms=this.resources.advancedBloomUniforms.uniforms,this._extractFilter=new Ux({threshold:t.threshold}),this._blurFilter=new Yc({strength:t.kernels??t.blur,quality:t.kernels?void 0:t.quality}),Object.assign(this,t)}apply(t,e,i,r){const s=Lt.getSameSizeTexture(e);this._extractFilter.apply(t,e,s,!0);const o=Lt.getSameSizeTexture(e);this._blurFilter.apply(t,s,o,!0),this.uniforms.uBloomScale=this.bloomScale,this.uniforms.uBrightness=this.brightness,this.resources.uMapTexture=o.source,t.applyFilter(this,e,i,r),Lt.returnTexture(o),Lt.returnTexture(s)}get threshold(){return this._extractFilter.threshold}set threshold(t){this._extractFilter.threshold=t}get kernels(){return this._blurFilter.kernels}set kernels(t){this._blurFilter.kernels=t}get blur(){return this._blurFilter.strength}set blur(t){this._blurFilter.strength=t}get quality(){return this._blurFilter.quality}set quality(t){this._blurFilter.quality=t}get pixelSize(){return this._blurFilter.pixelSize}set pixelSize(t){typeof t=="number"&&(t={x:t,y:t}),Array.isArray(t)&&(t={x:t[0],y:t[1]}),this._blurFilter.pixelSize=t}get pixelSizeX(){return this._blurFilter.pixelSizeX}set pixelSizeX(t){this._blurFilter.pixelSizeX=t}get pixelSizeY(){return this._blurFilter.pixelSizeY}set pixelSizeY(t){this._blurFilter.pixelSizeY=t}};Ei(Gx,"DEFAULT_OPTIONS",{threshold:.5,bloomScale:1,brightness:1,blur:8,quality:4,pixelSize:{x:1,y:1}});var Nx=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Tv=`struct ColorOverlayUniforms {
    uColor: vec3<f32>,
    uAlpha: f32,
};
...
`,Pv=Object.defineProperty,Fv=(n,t,e)=>t in n?Pv(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Io=(n,t,e)=>(Fv(n,typeof t!="symbol"?t+"":t,e),e);const Mv=class nf extends X{constructor(...t){let e=t[0]??{};(typeof e=="number"||Array.isArray(e)||e instanceof Float32Array)&&(k("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),e={color:e},t[1]!==void 0&&(e.alpha=t[1])),e={...nf.DEFAULT_OPTIONS,...e};const i=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:Tv,entryPoint:"mainFragment"}}),r=$.from({vertex:q,fragment:Av,name:"color-overlay-filter"});super({gpuProgram:i,glProgram:r,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"}}}}),Io(this,"uniforms"),Io(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new j,this.color=e.color??0}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,i,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=i,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};Io(Mv,"DEFAULT_OPTIONS",{color:0,alpha:1});var Iv=`in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Ev=`struct ColorReplaceUniforms {
...
fn mainFragment(
    ...
    return finalColor;
}`,Uv=Object.defineProperty,Lv=(n,t,e)=>t in n?Uv(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,sf=(n,t,e)=>(Lv(n,typeof t!="symbol"?t+"":t,e),e);const Dv=class of extends X{constructor(...t){let e=t[0]??{};Array.isArray(e)&&(k("6.0.0","ConvolutionFilter constructor params are now options object. See params: { matrix, width, height }"),e={matrix:e},t[1]!==void 0&&(e.width=t[1]),t[2]!==void 0&&(e.height=t[2])),e={...of.DEFAULT_OPTIONS,...e};const i=e.width??200,r=e.height??200,s=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:Bv,entryPoint:"mainFragment"}}),o=$.from({vertex:q,fragment:kv,name:"convolution-filter"});super({gpuProgram:s,glProgram:o,resources:{convolutionUniforms:{uMatrix:{value:e.matrix,type:"mat3x3<f32>"},uTexelSize:{value:{x:1/i,y:1/r},type:"vec2<f32>"}}}}),sf(this,"uniforms"),this.uniforms=this.resources.convolutionUniforms.uniforms,this.width=i,this.height=r}get matrix(){return this.uniforms.uMatrix}set matrix(t){t.forEach((e,i)=>{this.uniforms.uMatrix[i]=e})}get width(){return 1/this.uniforms.uTexelSize.x}set width(t){this.uniforms.uTexelSize.x=1/t}get height(){return 1/this.uniforms.uTexelSize.y}set height(t){this.uniforms.uTexelSize.y=1/t}};sf(Dv,"DEFAULT_OPTIONS",{matrix:new Float32Array(9),width:200,height:200});var Gv=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
}`,Hv=Object.defineProperty,jv=(n,t,e)=>t in n?Hv(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,qv=(n,t,e)=>(jv(n,t+"",e),e);const Kv=class lf extends X{constructor(...t){let e=t[0]??{};typeof e=="number"&&(k("6.0.0","DotFilter constructor params are now options object. See params: { scale, angle, grayscale }"),e={scale:e},t[1]!==void 0&&(e.angle=t[1]),t[2]!==void 0&&(e.grayscale=t[2])),e={...lf.DEFAULT_OPTIONS,...e};const i={uScale:{value:e.scale,type:"f32"},uAngle:{value:e.angle,type:"f32"},uGrayScale:{value:e.grayscale?1:0,type:"f32"}},r=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:Xv,entryPoint:"mainFragment"}}),s=$.from({vertex:q,fragment:Yv,name:"dot-filter"});super({gpuProgram:r,glProgram:s,resources:{dotUniforms:i}})}get scale(){return this.resources.dotUniforms.uniforms.uScale}set scale(t){this.resources.dotUniforms.uniforms.uScale=t}get angle(){return this.resources.dotUniforms.uniforms.uAngle}set angle(t){this.resources.dotUniforms.uniforms.uAngle=t}get grayscale(){return this.resources.dotUniforms.uniforms.uGrayScale===1}set grayscale(t){this.resources.dotUniforms.uniforms.uGrayScale=t?1:0}};qv(Kv,"DEFAULT_OPTIONS",{scale:1,angle:5,grayscale:!0});var Qv=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,py=`// Taken from https://gist.github.com/munrocket/236ed5ba7e409b8bdf1ff6eca5dcdc39
...
const MAX_KERNEL_SIZE: f32 = 2048;`,Ay=Object.defineProperty,Ty=(n,t,e)=>t in n?Ay(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Oo=(n,t,e)=>(Ty(n,typeof t!="symbol"?t+"":t,e),e);const Py=class mf extends X{constructor(...t){let e=t[0]??{};if(Array.isArray(e)||"x"in e&&"y"in e||e instanceof Ot){k("6.0.0","MotionBlurFilter constructor params are now options object. See params: { velocity, kernelSize, offset }");const s="x"in e?e.x:e[0],o="y"in e?e.y:e[1];e={velocity:{x:s,y:o}},t[1]!==void 0&&(e.kernelSize=t[1]),t[2]!==void 0&&(e.offset=t[2])}e={...mf.DEFAULT_OPTIONS,...e};const i=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:Cy,entryPoint:"mainFragment"}}),r=$.from({vertex:q,fragment:wy,name:"motion-blur-filter"});super({gpuProgram:i,glProgram:r,resources:{motionBlurUniforms:{uVelocity:{value:e.velocity,type:"vec2<f32>"},uKernelSize:{value:Math.trunc(e.kernelSize??5),type:"i32"},uOffset:{value:e.offset,type:"f32"}}}}),Oo(this,"uniforms"),Oo(this,"_kernelSize"),this.uniforms=this.resources.motionBlurUniforms.uniforms,Object.assign(this,e)}get velocity(){return this.uniforms.uVelocity}set velocity(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uVelocity=t,this._updateDirty()}get velocityX(){return this.velocity.x}set velocityX(t){this.velocity.x=t,this._updateDirty()}get velocityY(){return this.velocity.y}set velocityY(t){this.velocity.y=t,this._updateDirty()}get kernelSize(){return this._kernelSize}set kernelSize(t){this._kernelSize=t,this._updateDirty()}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}_updateDirty(){this.padding=(Math.max(Math.abs(this.velocityX),Math.abs(this.velocityY))>>0)+1,this.uniforms.uKernelSize=this.velocityX!==0||this.velocityY!==0?this._kernelSize:0}};Oo(Py,"DEFAULT_OPTIONS",{velocity:{x:0,y:0},kernelSize:5,offset:0});var Fy=`in vec2 vTextureCoord;
out vec4 finalColor;
...
`,My=`struct MultiColorReplaceUniforms {
...
`,u2=`struct SimpleLightmapUniforms {
  uColor: vec3<f32>,
  uAlpha: f32,
  uDimensions: vec2<f32>,
};
...
`,y2=Object.defineProperty,b2=(n,t,e)=>t in n?y2(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Af=(n,t,e)=>(b2(n,typeof t!="symbol"?t+"":t,e),e);const S2=class Tf extends X{constructor(t){t={...Tf.DEFAULT_OPTIONS,...t};const e=W.from({vertex:{source:K,entryPoint:"mainVertex"},fragment:{source:v2,entryPoint:"mainFragment"}}),i=$.from({vertex:q,fragment:x2,name:"twist-filter"});super({gpuProgram:e,glProgram:i,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),Af(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};Af(S2,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var w2=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
